            ...
            <tbody>
              <tr v-for="(item, index) in pageObj.list" :key="index">
                <td v-if="item.courseResp">
                  <img :alt="item.courseResp.courseName" :height="80" :src="item.courseResp.courseLogo">
                  <div>
                ...
                <td v-if="item.courseResp" style="float: right;margin-top: 10px">
                  <nuxt-link :to="{name: 'course-id', params: {id: item.courseResp.id}}" class="go_btn" target="_blank">
                    马上学习
                  </nuxt-link>
                </td>
              </tr>
