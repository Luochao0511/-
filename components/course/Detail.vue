...
<template>
  <div class="">
        ...
        <div class="clearfix">
          <div class="video_box">
            <div
              id="player"
              ref="videobox"
              :style="'background-image:url('+courseInfo.courseLogo+')'"
              class="detail_view"
            />
          </div>
          <div class="view_info">
            ...
            <div class="view_price">
              <div>
                价格:<span v-if="courseInfo.coursePrice === 0">免费</span> <span v-else>￥{{ courseInfo.coursePrice }} <b
                  style="text-decoration-line: line-through;font-size: 18px"
                >￥{{ courseInfo.rulingPrice }}</b></span>
              </div>
            </div>
            ...
            <div class="foot_box">
              ...
              <div class="handle_info_btn">
                ...
                <div class="handle_info_btn collect_btn" @click="handleCollect">
                  <img v-if="isCollect" alt="" src="@/assets/image/icon_collect_active.svg">
                  <img v-else alt="" src="@/assets/image/icon_collect.svg">
                  收藏
                </div>
              </div>
            </div>
    ...
    <d-pay v-if="showPay" :data="payData" :is-course="true" @hidefun="showPay = false" />
  </div>
</template>
<script>
