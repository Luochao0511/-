  ...
  <div class="">
    ...
    <div class="paymodal codemodal">
      ...
      <div v-else class="modal_body">
        <div class="pay_type">
          <input id="payType2" v-model="payType" name="payType" type="radio" value="2">
          <label class="pay pay_ali" for="payType2" @click="changePay(2)" />
          <input id="payType1" v-model="payType" name="payType" type="radio" value="1">
          <label class="pay pay_weixin" for="payType1" @click="changePay(1)" />
        </div>
